...
*/
identify "Alternating Bit (using station and communication groups)";
...
void Root::defineTraffic () {
  ...
  sg1 = create SGroup (1, Sender);
  sg2 = create SGroup (1, Recipient);
  cg = create CGroup (sg1, sg2);
  tp = create TrafficType (cg, MIT_exp + MLE_fix,
