...
// This is generated by picomp (in a malloc-fail-safe way); this old
// invocation is for compatibility with old PLibs functions
// #define	call(p,d,s)	do { if (join (fork (p, d), s)) release; } while (0)
