#ifndef	__pg_rf24l01_sys_h
#define	__pg_rf24l01_sys_h	1
/* ==================================================================== */
...
/*
 * Pin assignment: this is temporary -> to use the versa board
 * Use #define TARGET_BOARD BOARD_VERSA2 for this setup
 *
 *  RF24L01                     MSP430Fxxx
 * ===========================================
