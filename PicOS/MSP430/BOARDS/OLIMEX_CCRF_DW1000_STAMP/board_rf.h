...
#define	dw1000_sclk_up		_BIS (P2OUT, 0x08)
#define	dw1000_sclk_down	_BIC (P2OUT, 0x08)

#define	dw1000_so_val		(P2IN & 0x40)

#define	dw1000_si_up		_BIS (P2OUT, 0x10)
#define	dw1000_si_down		_BIC (P2OUT, 0x10)
