...
#define	sd_clkh		_BIS (P6OUT, 0x10)
#define	sd_clkl		_BIC (P6OUT, 0x10)

#define	sd_outh		_BIS (P6OUT, 0x40)
#define	sd_outl		_BIC (P6OUT, 0x40)

#define	sd_inp		(P6IN & 0x08)

#define	sd_start	_BIC (P6OUT, 0x80)
#define	sd_stop		_BIS (P6OUT, 0x80)
