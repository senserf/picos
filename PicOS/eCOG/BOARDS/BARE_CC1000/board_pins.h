...
// Confirmed IO pins: A:0-7/GPIO 0-8 (incl leds), B:3-5/GPIO 8-10,
// 		    : D:2-3/GPIO 21-22, J:2-5/GPIO 17-20, C:3/GPIO16
...
#define	PORT_B_SELECT		fd.port.sel1.b = 3
	 ...
	 * for C3 (GPIO16), which is usable.
	 */
#define	PORT_C_ENABLE		PORT_EN_C_MASK
#define PORT_C_SELECT		fd.port.sel1.c = 3
