...
#define	LED0_ON		__pi_LEDS03 (0x0002)
#define	LED1_ON		__pi_LEDS03 (0x0020)
#define	LED2_ON		__pi_LEDS03 (0x0200)
#define	LED3_ON		__pi_LEDS03 (0x2000)

#define	LED0_OFF	__pi_LEDS03 (0x0001)
#define	LED1_OFF	__pi_LEDS03 (0x0010)
#define	LED2_OFF	__pi_LEDS03 (0x0100)
#define	LED3_OFF	__pi_LEDS03 (0x1000)
