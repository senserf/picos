...
//
	...
	// Precompute the Trim; I used to have the next statement, TIRTOS
	// driver doesn't seem to have it; seems to make no difference, so
	// I'm taking it out (231005)
