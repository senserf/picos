...
lcdg_dm_obj_t	*LCDG_DM_TOP = NULL,	// Top object displayed
		*LCDG_DM_HEAD = NULL;	// The front of the list of displayed
					// objects

byte		LCDG_DM_STATUS	= 0;	// Error status

static word	lcdg_dm_wph = 0;	// Wallpaper image handle
