...
\begin{quote}
\noindent\hspace{-0.35in}{\small {\bf {\tt double RFC\_att (const SLEntry *sl, double d, Transceiver *src, Transceiver *dst);}}} \hspace{0in}\vspace{0.05in}\\
\noindent
...
\begin{quote}
\noindent\hspace{-0.35in}{\bf {\tt IPointer setTag (IPointer tag);}} \hspace{0in}\vspace{0.05in}\\
\noindent
