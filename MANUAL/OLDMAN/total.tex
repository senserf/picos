...
\ \resizebox{90mm}{!}{\includegraphics{FIGURES/hier.png}}
...
\begin{quote}
\noindent\hspace{-0.35in}{\bf {\tt RATE setTRate (RATE r = RATE\_inf);}} \hspace{0in}\vspace{0.05in}\\
\noindent
...
{\tt TRate}---\sect{rm_po_ac_st}) and involves {\tt RFC\_xmt}
(\sect{rm_tr_ac_st}).
...
If {\tt setTRate} is invoked after {\tt startTransmit} or {\tt transmit} but
...
default, e.g., as for channel {\tt setTRate}---\sect{rm_to_tr_cr}).
...
\begin{figure}
\begin{center}
\ \resizebox{90mm}{!}{\includegraphics{FIGURES/hoo.png}}
