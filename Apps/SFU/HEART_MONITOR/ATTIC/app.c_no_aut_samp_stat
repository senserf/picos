...
#define	SM_XMIT		0x02	// Offsets to PT_SAMPLE
#define	SM_HRMON	0x01	// ...
...
byte	DispToggle = 0;
byte	LostSamples = 0;
Boolean	HREndOnEOS,		// Terminate HR monitor when end of sampling
...
NextSample:
	...
	if (XWS && QPackets <= PACKET_QUEUE_LIMIT) {
		// Send this sample
