...
#if MAX_PACKET_LENGTH == MIN_PACKET_LENGTH
...
static word gen_backoff (void) {
	...
	return BounceBackoff ? (rnd () & BounceBackoff) : 0;
}
...
diag (
	...
	"z n      -> read pin n\r\n"
	"l p d r  -> read analog pin p with delay d, reference r\r\n"
#ifdef PULSE_MONITOR
