...
// msg_rpc_in() is shortcut in app.c because of cmd line sharing
// msg_rpc_out() is shortcut in oss_rpc_in, because of laziness
...
extern void oss_info_in (word state, id_t rcv);

extern void oss_traceAck_out (char * buf, word len, word fmt);
