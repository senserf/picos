...
idiosyncratic void write_mark (word what) {
...
idiosyncratic void write_agg (word ti) {
	...
	agg_data.ee.sval[5] = tagArray[ti].rpload.ppload.sval[5];
        ...
        agg_data.ee.sval[6] = tagArray[ti].rpload.ppload.sval[6];
        agg_data.ee.sval[7] = tagArray[ti].rpload.ppload.sval[7];
        agg_data.ee.sval[8] = tagArray[ti].rpload.ppload.sval[8];
        agg_data.ee.sval[9] = tagArray[ti].rpload.ppload.sval[9];
        agg_data.ee.sval[10] = tagArray[ti].rpload.ppload.sval[10];
#endif
